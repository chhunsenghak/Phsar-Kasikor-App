...
import 'market_price_tracker.dart';
import 'community_portal.dart';
import 'user_profile_settings.dart';
import 'farmer_dashboard.dart';
import 'admin_dashboard_overview.dart';
import 'refined_farmer_verification_queue.dart';
import 'content_review_moderation.dart';
...
class _AppShellState extends State<AppShell> {
  ...
  Widget build(BuildContext context) {
    ...
    final activeWidget = navItems[_selectedIndex]['screen'] as Widget;
